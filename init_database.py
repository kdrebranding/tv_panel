...
async def init_database():
    ...
    sample_clients = [
        ...
        },
        {
            "id": "client-2", 
            "name": "Anna Nowak",
            "expires_date": datetime.combine(today + timedelta(days=5), datetime.min.time()),
            "panel_id": "panel-2",
            "login": "annanowak",
            "password": "secure456",
            "app_id": "app-2",
        ...
        },
        {
            ...
            "expires_date": datetime.combine(today + timedelta(days=90), datetime.min.time()),
            "panel_id": "panel-2",
            "login": "mariuszk",
            "password": "newpass321", 
            "app_id": "app-4",
        ...
        },
        {
            ...
            "expires_date": datetime.combine(today + timedelta(days=15), datetime.min.time()),
            "panel_id": "panel-3",
            "login": "kzielinska", 
            "password": "kasia2024",
            "app_id": "app-5",
